...
# by a space. There shouldn't be leading or trailing spaces. Please note that
# the uniq -c command by itself will generate the output in a different
# format. This time, compare consecutive lines in a case insensitive manner.
